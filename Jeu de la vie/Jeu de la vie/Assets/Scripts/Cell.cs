...
public class Cell : MonoBehaviour
{
     ...
     **/
    // Le variable NbCasesParAxe donne le nombre de "cases" ou "cellules" maximal par axe (donc le jeu contient au maximum NbCasesParAxe*NbCasesParAxe*NbCasesParAxe ici donc 12*12*12=1728cellules maximal)
    public int NbCasesParAxe = 12; 
    // Le variable SousPop donne le nombre de voisin pour considérer comme Sous population 
    public int SousPop = 5; 
    // Le variable SourPop donne le nombre de voisin pour considérer comme Sur population 
    public int SurPop = 7;
    // Le variable naitre donne le nombre de voisin pour faire naitre la cellules 
    public int naitre = 0;
    // Le variable voisinCases Nombres de cases requises pour comsidérer comme voisin. (si voisinCases = 1 alors cellules a 26voisins, et si voisinCases = 2 alors 124 voisins
    public int voisinCases = 1; 
    // Le variable toroidale permet de controler le jeu si il sera toroidale (signifie qu'un des voisins de (0,0,0) sera (11,11,11) dans le cas si sur un axe a maximum 12 cases ) 
    public bool toroidale = false; 
    
    // Le variable couleur permet de laisser à utilisateur de choisir s'il veut utiliser la code couleur 
    public bool codeCouleur = false;
